...
- Separate reviewers flag the same issue independently. Sequential passes by one agent do not supply this signal, even when every pass repeats the finding.
