...
- `Read` tool calls against any `SKILL.md` file (workspace `.agents/skills/`, user-level `~/.config/pstack/skills/`, or plugin-installed paths under `the configured skill installation root`)
