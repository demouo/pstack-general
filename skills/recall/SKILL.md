...
Read history through the workspace-scoped history capability or an explicitly configured export. Inspect its format. If neither exists, use the current conversation and saved handoff files; report that older history is unavailable.
